-- ====================================================================
-- Migration 022: Game Balance & Ticket Conversion Architecture
-- Phase 2 Foundation: Real-balance cash-to-ticket & ticket-to-cash conversions,
-- atomic bridge reconciliation ledger, unified global lock hierarchy,
-- retirement of promotional free-ticket creation, and PayRupee isolation.
--
-- STRICT ISOLATION & INTEGRITY NOTICE:
-- 1. Decoupled from PayRupee payout API.
-- 2. Bank withdrawals remain the sole payout path.
-- 3. Lifafa reserved_balance escrow is never touched.
-- 4. Migrations 001-021 remain 100% untouched.
-- ====================================================================
